...
class News(models.Model):  #для этого создаём класс, который наследуется от модуля models и в нём класс Model
    ...
    def __str__(self):
        ...
        :return: # Номер_новости Заголовок_новости
        """
    ...
    class Meta:
        ...
        # ordering = ('created_at',)  # это сортировка новостей в админке
...
class Course(models.Model):
    ...
    def __str__(self):
        """
        это отображение курса в админке
        :return: str -> Заголовок_курса
        """
        return f'{self.title}'
...
# ниже реализуем отправку отзывов на курсы
class CourseFeedback(models.Model):
    """
    RATINGS - оценки от 5 до 1 (кортеж кортежей - будет выводиться в интерфейсе)
    ⭐ - это unicode-символ, поэтому его можно использовать
    """
    RATINGS = (
        (5, '⭐⭐⭐⭐⭐'),
        (4, '⭐⭐⭐⭐'),
    ...
    # у rating обозначаем предуставленный список значений:
